...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<DtoApiError> handleResourceNotFound(
        ...
        log.error("Recurso no encontrado en producto path={}", request.getRequestURI(), ex);
    ...
    public ResponseEntity<DtoApiError> handleValidation(
        ...
        log.error("Error de validacion en producto path={} mensaje={}", request.getRequestURI(), message, ex);
    ...
    public ResponseEntity<DtoApiError> handleRuntime(
        ...
        log.error("Error de negocio en producto path={}", request.getRequestURI(), ex);
