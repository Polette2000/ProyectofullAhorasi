...
@Data
@Schema(description = "Datos requeridos para actualizar un proveedor")
public class ProveedorUpdateRequest {
    ...
    @Schema(description = "Correo de contacto del proveedor", example = "ventas@aromaschile.cl", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Telefono de contacto del proveedor", example = "+56987654321", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Direccion fisica del proveedor", example = "Av. Principal 456, Santiago", requiredMode = Schema.RequiredMode.REQUIRED)
